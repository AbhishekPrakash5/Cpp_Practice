...
{
int f=0; clrscr();
ifstream fn("Ticket1.dat",ios:: binary|| ios::out); fn.seekg(0);
if(!fn)
{
...
clrscr();
gotoxy(10,10); 
cout<<"RESERVATION "; gotoxy(10,12);
cout<<"ENTER THE TRAIN NO: ";
int tno,f=0; cin>>tno;
ofstream file;
ifstream fin("Train1.dat",ios:: binary|| ios::out); 
fin.seekg(0);
if(!fin)
{
clrscr();
...
{
clrscr(); ifstream fin;
fin.open("Ticket1.dat",ios:: binary|| ios::out);
 
ofstream file;
file.open("Temp1.dat",ios:: binary|| ios::app);
fin.seekg(0);
gotoxy(10,10);
...
getch();
X:
ofstream fout("Train1.dat",ios:: binary|| ios::app); tr.input();
